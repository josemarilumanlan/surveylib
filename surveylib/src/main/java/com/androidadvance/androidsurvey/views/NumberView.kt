...
class NumberView(val surveyView: SurveyView, val q_data: Question) : FrameLayout(surveyView.context) {
    ...
    override fun onAttachedToWindow() {
        ...
        val textview_q_title = root.findViewById(R.id.textview_q_title) as TextView
        val editText_answer = root.findViewById(R.id.editText_answer)as EditText
        editText_answer.inputType = InputType.TYPE_CLASS_NUMBER or InputType.TYPE_NUMBER_FLAG_DECIMAL
